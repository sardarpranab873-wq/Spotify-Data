...
Identify correlations between numerical and categorical variables.
...
Central tendency (mean, median, mode) and spread (standard deviation, range)

Visualization techniques: histograms, boxplots, bar charts, pie charts

2️. Bivariate Analysis

Correlation between numerical variables (e.g., energy vs. loudness, danceability vs. valence)
